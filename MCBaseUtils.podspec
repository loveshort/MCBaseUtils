...
Pod::Spec.new do |s|
  s.name             = 'MCBaseUtils'
  s.version          = '0.1.0'
  s.summary          = 'A short description of MCBaseUtils.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/mxx/MCBaseUtils'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'mxx' => '271901088@qq.com' }
  s.source           = { :git => 'https://github.com/mxx/MCBaseUtils.git', :tag => s.version.to_s }
